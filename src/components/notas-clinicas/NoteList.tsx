        ...
        <Table className="min-w-[768px]">
          <TableHeader className="bg-gray-100">
            <TableRow>
              ...
              <TableHead className="text-left font-bold text-foreground w-1/3">
                Resumo da Nota
              </TableHead>
          ...
          <TableBody>
            {notes.map((note: any) => (
              ...
              >
                ...
                <TableCell className="text-left max-w-[300px] truncate text-muted-foreground">
                  {note.content}
                </TableCell>
          ...
          >
            <div className="flex justify-between items-start mb-2">
              <div className="font-bold text-base text-foreground">
                {note.expand?.professional_id?.name}
              </div>
            ...
            <p className="text-sm line-clamp-2 text-foreground/80 mb-4">{note.content}</p>
