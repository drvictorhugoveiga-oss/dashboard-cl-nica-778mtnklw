...
import { ProfessionalCostsDialog } from './ProfessionalCostsDialog'
import { useToast } from '@/hooks/use-toast'
import { Badge } from '@/components/ui/badge'

export function ProfessionalCostsList() {
          ...
          <TableBody>
            {data.map((item) => (
              <TableRow key={item.id}>
                <TableCell>{item.date ? format(new Date(item.date), 'MM/yyyy') : 'N/A'}</TableCell>
